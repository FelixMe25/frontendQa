export async function Sedes() {
  try {
  const response = await fetch("https://backend-qa-one.vercel.app/estadisticas/sede");
    if (!response.ok) {
...
export async function levantamientos(semestral) {
  let semestre = [];
  try {
  const response = await fetch("https://backend-qa-one.vercel.app/estadisticas/levantamientos");
    if (!response.ok) {
      throw new Error('Error en la respuesta de la API');
    }
    const data = await response.json();
...
export async function levantamientosAprobados(semestral) {
  let semestre = [];
  try{
  const response = await fetch("https://backend-qa-one.vercel.app/estadisticas/seguimiento/levantamientos");
    if (!response.ok) {
      throw new Error('Error en la respuesta de la API');
    }
    const data = await response.json();
...
export async function levantamientosAprobadosTotal(semestral) {
  let semestre = [];
  try{
  const response = await fetch("https://backend-qa-one.vercel.app/estadisticas/seguimiento/levantamientos/data");
    if (!response.ok) {
      throw new Error('Error en la respuesta de la API');
    }
    const data = await response.json();
...
export async function totallevRN(semestral) {
  let semestre = [];
  try {
  const response = await fetch("https://backend-qa-one.vercel.app/estadisticas/seguimiento/levantamientos/rn");
    if (!response.ok) {
      throw new Error('Error en la respuesta de la API');
    }
    const data = await response.json();
...
export async function inclusiones(semestral) {
  let semestre = [];
  try {
  const response = await fetch("https://backend-qa-one.vercel.app/estadisticas/inclusiones");
    if (!response.ok) {
      throw new Error('Error en la respuesta de la API');
    }
    const data = await response.json();
...
export async function inclusionesAprobadas(semestral) {
  let semestre = [];
  try{
  const response = await fetch("https://backend-qa-one.vercel.app/estadisticas/seguimiento/inclusiones");
    if (!response.ok) {
      throw new Error('Error en la respuesta de la API');
    }
    const data = await response.json();
