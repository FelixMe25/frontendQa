    ...
    const fetchData = async () => {
      try {
        const responses = await Promise.all([
          fetch('https://backend-qa-one.vercel.app/procesos/Inclusión de curso'),
          fetch('https://backend-qa-one.vercel.app/procesos/Levantamiento de requisitos'),
          fetch('https://backend-qa-one.vercel.app/procesos/Retiro')
        ]);
